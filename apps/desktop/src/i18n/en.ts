...
export const en: Translations = {
    ...
    uninstallSection: {
      ...
      options: {
        gui: {
          ...
          description: 'Remove this desktop app. The CommonAgent agent, your config, and chats all stay.',
          consequence: 'the desktop Chat GUI (this app and its data)'
        },
        lite: {
          title: 'Uninstall GUI + agent, keep my data',
          description:
            'Remove the app and the CommonAgent agent, but keep config, chats, and secrets for a future reinstall.',
          consequence: 'the Chat GUI and the CommonAgent agent (config, chats, and secrets are kept)'
        },
        full: {
          title: 'Uninstall everything',
          description: 'Remove the app, the agent, and all user data — config, chats, scheduled jobs, secrets, logs.',
          consequence: 'EVERYTHING — the Chat GUI, the CommonAgent agent, and all of your config, chats, secrets, and logs'
        }
      }
    },
    poolLimits: {
  ...
  skills: {
    ...
    plugins: {
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the CommonAgent plugin catalog. Nothing was installed.`,
  ...
  updates: {
    ...
    applyingBodyAppInstaller:
      'CommonAgent will close and Windows will finish the update. CommonAgent will reopen when it’s done — you don’t need to do anything.',
    applyingCloseAppInstaller: 'This window will close, Windows finishes the update, and CommonAgent reopens on its own.',
    checkUnknownTitleAppInstaller: 'Couldn’t check for updates',
    checkUnknownBodyAppInstaller:
      'Windows couldn’t check for updates right now. Updates also install automatically when you restart CommonAgent.',
